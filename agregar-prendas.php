...
<!--- Icono uno -->
   ...
   <div class="categiorias-menu-app" style="background-color:#bdc3c7;">
  ...
  <div class="categiorias-menu-app">
   ...
   <!--- Icono uno -->
    ...
    <br>
  <div data-type="timetable"  class="contenedor-agregar-prendas">


<center>
    

<div class="cajas-agregar">
    <a href="Subirimagenes/seccion-camisetas.php" class="lk-agregar-prenda">Camisetas</a>    
</div>
<div class="cajas-agregar">
    <a href="Subirimagenes/seccion-pantalones.php" class="lk-agregar-prenda">Pantalones</a>    
</div>
<div class="cajas-agregar">
    <a href="Subirimagenes/seccion-calzados.php" class="lk-agregar-prenda">Calzados</a>    
</div>
...
<script src="js/button-animate-burbujas.js"></script>
